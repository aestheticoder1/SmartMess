...
const AdminMenuPage = () => {
    ...
    const handleAddOrUpdate = async (e) => {
        ...
        try {
            if (editDay) {
                await axios.put(`http://localhost:5000/api/menu/update/${editDay}`, formData, { withCredentials: true });
                toast.success("Menu updated successfully");
            } else {
                await axios.post("http://localhost:5000/api/menu/add", formData, { withCredentials: true });
    ...
    const handleDelete = async (day) => {
        try {
            await axios.delete(`http://localhost:5000/api/menu/delete/${day}`, { withCredentials: true });
